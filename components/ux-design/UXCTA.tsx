...
export function UXCTA() {
  const { cta } = uxPage;

  return (
    <section className="border-t border-ink/8 bg-soft-white text-ink">
      <div className="page-shell grid items-end gap-10 pt-[clamp(8.75rem,16vw,12.5rem)] pb-[clamp(7.5rem,14vw,10rem)] lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)]">
